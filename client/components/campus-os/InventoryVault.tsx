    ...
    <div className="h-full flex flex-col gap-4 overflow-hidden">
            ...
            <section>
                ...
                <div className="space-y-3">
                    {scrolls.map(scroll => (
                        <Card 
                          key={scroll.id} 
                          className="flex items-center justify-between p-3 hover:bg-muted/50 cursor-pointer border-border active:scale-[0.98] transition-all shadow-sm"
                        >
                          <div className="flex items-center gap-3 w-full" onClick={() => setSelectedItem(scroll)}>
                              <div className="w-10 h-10 bg-amber-100 rounded-md flex items-center justify-center border border-amber-200">
                                  <Scroll className="w-5 h-5 text-amber-600" />
                              </div>
                              <div className="flex-1">
                                  <p className="font-bold text-sm text-foreground">{scroll.name}</p>
                                  <p className="text-[10px] font-mono text-muted-foreground">Issued: {scroll.date}</p>
                              </div>
      ...
      {selectedItem && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <Card className="w-full max-w-md relative z-10 animate-[scaleIn_0.2s_ease-out] bg-card border-border shadow-lg">
